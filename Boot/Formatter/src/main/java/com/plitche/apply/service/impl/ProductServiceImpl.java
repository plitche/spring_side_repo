 ...
 * All rights reserved.
 */
package com.plitche.apply.service.impl;
...
import com.plitche.apply.service.ProductService;
...
public class ProductServiceImpl implements ProductService {
  ...
  public void addProduct(
      Long id, String name, int price, int stock, String serialNo, String description) {
    Product product =
        Product.builder()
            .id(id)
            .name(name)
